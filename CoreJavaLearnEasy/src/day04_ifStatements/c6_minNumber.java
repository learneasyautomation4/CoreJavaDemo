...
public class c6_minNumber {
    ...
    public static void main(String [] args){
        ...
        if (xMin){//false
            System.out.println("Miniumum number is "+ x); // it wont print this one
        }

        if (yMin){//true
            System.out.println("Miniumum number is " + y );//this will be printed
        }

        if (zMin){//false
            System.out.println("Miniumum number is "+ z);//it wont print this one
        }
