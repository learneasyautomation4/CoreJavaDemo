...
public class c5_StringMethods4 {
    ...
    public static void main(String[] args) {
        ...
        String fullName="Learneasy Automation";
        System.out.println(fullName.toLowerCase());//learneasyautomation
        System.out.println(fullName.toUpperCase());//LEARNEASYAUTOAMTION

        String fullName2="Sangeetha kaLRa";
                        //012345678
        //print me initials are capital
        ...
        //if you want to remove all spaces from sentence
