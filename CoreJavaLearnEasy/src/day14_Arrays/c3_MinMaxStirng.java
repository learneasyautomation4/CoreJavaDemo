...
//ex         String[] names = {"hello", "world", "java", "pyton", "kavitha", "learneasyautomation"};
//output :learneasyautomation
//write a program that can return the shortest string of text from an array
////ex         String[] names = {"hello", "world", "java", "pyton", "JS" "kavitha", "learneasyautomation"};
//output : JS

        String [] names={"hello", "world", "java", "pyton", "kavitha", "learneasyautomation", "JS"};
